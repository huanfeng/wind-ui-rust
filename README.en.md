...
| System | System tray (icon + left/double click + native context menu), global hotkeys (Windows), multi-window (`ctx.open_window`), start hidden, close-to-hide, frameless window (custom title bar), file drop, clipboard |
